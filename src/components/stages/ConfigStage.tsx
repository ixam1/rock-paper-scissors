...
function ConfigStage({
	...
	return (
		<div className="flex flex-col items-center gap-8">
			<div className="w-full p-6 shadow xl:p-8 bg-slate-50 sm:w-96 rounded-xl dark:bg-slate-800">
				<h1 className="text-2xl font-extrabold tracking-wider uppercase xl:text-3xl">
					<div>Rock</div> <div>Paper</div> <div>Scissors</div>
				</h1>
			</div>

			<fieldset className="w-full p-6 pt-6 border xl:p-8 border-slate-600 dark:border-slate-300 rounded-xl sm:w-96">
